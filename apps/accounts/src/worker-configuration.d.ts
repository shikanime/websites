/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 3b87a562a49f8ed98a3f32a0c4f24722)
// Runtime types generated with workerd@1.20260421.1 2025-12-25 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DB: D1Database;
		BETTER_AUTH_URL: "https://accounts.shikanime.studio";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "REIYA_CLIENT_SECRET">> {}
}
